...
export async function generateForecast(data, department = "", seasonalityPeriod = 4, alpha = 0.5, beta = 0.3, gamma = 0.2) {
...
export async function analyzeVariance(forecasts, historicalData) {
